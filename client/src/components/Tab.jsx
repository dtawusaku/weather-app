...
export default function Tab({ data }) {
  ...
  return (
    ...
    <motion.div className="tab">
      <div className="h-[3.6875rem] flex justify-between lg:pt-6 lg:pr-4">
        <div className="tab-headers flex justify-between space-x-40 lg:space-x-4">
          {/* Dynamic */}
          {data.map((entry, index) => (
            <div
              className={`lg:ml-4 ml-8 text-s3 pt-3 font-semibold ${
